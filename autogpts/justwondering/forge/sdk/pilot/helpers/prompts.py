...
from forge.sdk.pilot.const import common
from forge.sdk.pilot.const.llm import MAX_QUESTIONS, END_RESPONSE
from forge.sdk.pilot.utils.llm_connection import create_gpt_chat_completion, get_prompt
from forge.sdk.pilot.utils.utils import capitalize_first_word_with_underscores, get_sys_message, find_role_from_step
from forge.sdk.pilot.utils.questionary import styled_select, styled_text
from forge.sdk.pilot.logger.logger import logger
from forge.sdk.pilot.helpers.react_prompt import ZeroShotReactPrompt
from forge.sdk.pilot.helpers.rewoo_prompt import *
...
def generate_messages_from_custom_conversation(role, messages, start_role='user'):
    ...
    for i, message in enumerate(messages):
        if i % 2 == 0:
            ...
            result.append({"role": "assistant" if start_role ==
                          "user" else "user", "content": message})
