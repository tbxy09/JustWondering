...
from forge.sdk.pilot.database.database import save_progress, save_app, get_progress_steps
from forge.sdk.pilot.utils.utils import execute_step, generate_app_data, step_already_finished, clean_filename
from forge.sdk.pilot.utils.files import setup_workspace
from forge.sdk.pilot.helpers.prompts import ask_for_app_type, ask_for_main_app_definition, get_additional_info_from_openai, \
    generate_messages_from_description, ask_user
from forge.sdk.pilot.const.llm import END_RESPONSE
...
class ProductOwner(Agent):
    ...
    def get_project_description(self):
        ...
        self.project.args['name'] = clean_filename(
            ask_user(self.project, 'What is the project name?'))
