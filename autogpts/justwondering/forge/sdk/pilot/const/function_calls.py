...
FILTER_OS_TECHNOLOGIES = {
    'definitions': [
        return_array_from_prompt(
            'os specific technologies', 'os specific technology', 'technologies')
    ],
    'functions': {
...
EXTRACT_GITHUB_REPO = {
    'definitions': [{
        ...
        'description': 'Extracts the github repo from the given url.',
        'parameters': {
            'type': 'object',
            "properties": {
                "url": {
                    "type": "string",
                    "description": 'URL of the github repo that needs to be extracted.',
                },
            },
            "required": ['url'],
        },
...
SUMMARY = {
    'definitions': [
        {
            ...
            'parameters': {
                    ...
                    'properties': {
                        'symbols': {
                            'type': 'array',
                            'description': 'list of symbol defined in the file, and how other classes might use them',
                            'items': {
                                'type': 'object',
                                'properties': {
                                    'symbol_name': {
                                    ...
                                    'reference': {
                                        'type': 'string',
                                        'description': 'how other classes might use them'
                                    }
                                }
                            }
                        }
    ...
    'functions': {
        'summary': lambda symbols: symbols
    }
}
CODE_SUMBIT = {
    'definitions': [
        {
            "name": "code_url",
            "description": "extract code from url and save as a snapshot",
            "parameters": {
                "type": "object",
                "properties": {
                    "url": {
        ...
        {
            "name": "code",
            "description": "save code as a snapshot",
            "parameters": {
                "type": "object",
                "properties": {
                    "code": {
    ...
    'functions': {
        'code_url': lambda url: (url, ['extract_code', 'save_code']),
        'code': lambda code: (code, 'save_code')
    }
}
STEP_NEXT = {
    'definitions': [
